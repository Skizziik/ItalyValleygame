...
## Project: Italy Valley

- **Engine**: Godot 4.6 (GL Compatibility, 2D pixel art)
- **Repo**: https://github.com/Skizziik/ItalyValleygame
- **Full GDD**: see `docs/GDD.md`
- **Task tracker**: see `docs/TASKS.md`
- **Roadmap**: see `docs/ROADMAP.md`
- **Commits**: frequent, small, conventional (`feat:`, `fix:`, `chore:`, `docs:`)
- **Languages**: RU + EN (i18n from the start)
- **Style**: small clear classes, no monoliths, data-driven (JSON), DEBUG toggle

### CRITICAL RULE: No half-measures

- **NO** placeholders, stubs, "TODO later", "v2", "post-MVP"
- **NO** intermediate versions — every feature ships at FINAL RELEASE quality
- **NO** "we'll polish this later" — polish it NOW
- Every system, UI element, animation, data file must be COMPLETE when committed
- If a feature isn't ready to be final — don't commit it yet, finish it first
